...
- [x] 1.2 Enhance log_audit() for same-object enrichment
...
- [x] 1.3 Add startup validation for route mapping completeness
...
- [x] 1.4 Unit tests for middleware
...
- [x] 2.1 Cluster domain — routes, upstreams, ssl, plugin_configs, global_rules, stream_proxies, dns_proxies, static_resources
...
- [x] 2.2 System domain — users, clickhouse_config, database, ansible_inventory
...
- [x] 3.2 Create audit log API module
