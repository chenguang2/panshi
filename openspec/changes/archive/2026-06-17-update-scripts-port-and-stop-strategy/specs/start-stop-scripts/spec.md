...
4. If no matching process is found, log but do not kill
...
- **WHEN** `product/linux/stop.sh` is executed and the process on the target port is NOT running `app.main:app`
