...
Provides HTTP status code classification and detailed breakdown statistics using ClickHouse metrics, enabling operators to understand error distribution and troubleshoot issues.
