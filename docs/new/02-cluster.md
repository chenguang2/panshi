...
| 描述 | 操作手册演示集群：承载 192.168.0.13-15 三台已装好网关软件的节点 | 备注信息 |
| Admin Key | （留空） | 与 Edge 节点通信验证的密钥，**必须与节点安装时设置的一致**；一般不用设置，不填系统会使用默认值 |
| 状态 | 正常 | 禁用后该集群不可发布 |
...
![集群列表卡片](images/01-05-cluster-show.png)
