...
class SslCertificate(Base):
    ...
    organizational_unit = Column(String(200), nullable=True)
    client_ca = Column(Text, nullable=True)
    client_depth = Column(Integer, nullable=True, default=1)
    skip_mtls_uri_regex = Column(Text, nullable=True)
